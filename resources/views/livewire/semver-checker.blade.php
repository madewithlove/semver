<div>
    ...
    <section>
        <form class="flex">
            <input wire:model="package" placeholder="Package" id="package" type="text" autofocus="" class="@if ($package === null) border-red-500 @endif flex-grow text-center border-2 border-gray-400 bg-gray-100 p-3 text-gray-400 focus:text-gray-500 outline-none mr-3 text-lg font-bold">
